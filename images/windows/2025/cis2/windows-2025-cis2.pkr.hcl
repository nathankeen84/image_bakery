...
locals {
  ...
  image_name    = "windows-2025-cis2"
  image_version = var.build_date
}

source "azure-arm" "windows_2025_cis2" {
...
build {
  ...
  provisioner "powershell" {
    inline = [
      "Write-Host '=== Starting Windows 2025 CIS L2 Build (Incremental on L1) ===' -ForegroundColor Green",
  ...
  provisioner "powershell" {
    inline = [
      ...
      "Write-Host 'Windows 2025 CIS L2 image build completed successfully' -ForegroundColor Green"
    ]
  }
}
