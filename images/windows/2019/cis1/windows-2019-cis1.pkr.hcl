...
locals {
  ...
  image_name    = "windows-2019-cis1"
  image_version = var.build_date
}

source "azure-arm" "windows_2019_cis1" {
...
build {
  ...
  provisioner "powershell" {
    inline = [
      "Write-Host '=== Starting Windows 2019 CIS L1 Build ===' -ForegroundColor Green",
  ...
  provisioner "powershell" {
    inline = [
      ...
      "Write-Host 'Windows 2019 image build completed successfully' -ForegroundColor Green"
    ]
  }
}
